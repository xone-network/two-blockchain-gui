...
import AppIcon from '../assets/img/two64x64.png';
...
// Set the userData directory to its location within TWO_ROOT/gui
setUserDataDir();
  ...
  if (ensureSingleInstance() && ensureCorrectEnvironment()) {
    ...
    const createWindow = async () => {
      if (manageDaemonLifetime(NET)) {
        greenBTCEnvironment.startTwoDaemon();
      }
  ...
  const getMenuTemplate = () => {
    const template = [
      ...
      },
      {
        ...
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'Two Blockchain Wiki' }),
            click: () => {
              openExternal(
                'https://github.com/xone-network/two-blockchain/wiki',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/xone-network/two-blockchain/wiki/FAQ',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/xone-network/two-blockchain/releases',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/xone-network/two-blockchain/blob/main/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/xone-network/two-blockchain/issues',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal('https://keybase.io/team/two_network.public');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
            click: () => {
              openExternal('https://twitter.com/two_project');
            },
          },
        ],
      },
    ...
    if (process.platform === 'darwin') {
      // Two Blockchain menu (Mac)
      template.unshift({
        label: i18n._(/* i18n */ { id: 'Two' }),
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'About Two Blockchain' }),
            click: () => {
              openAbout();
            },
          },
