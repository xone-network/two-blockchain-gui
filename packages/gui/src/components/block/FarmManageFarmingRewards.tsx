...
import { Button, Flex, Form, TextField, Loading } from '@two/core';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@two/api-react';
import {
  Alert,
  Dialog,
  DialogActions,
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    0.25XTWO reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
