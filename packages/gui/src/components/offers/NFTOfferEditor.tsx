...
import type { NFTInfo, Wallet } from '@two/api';
import {
...
/*       An NFT offer consists of a single NFT being offered for XTWO/CAT      */
/* ========================================================================== */
    ...
    if (
      ...
      switch (tokenWalletInfo.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToTwoLocaleString(
            walletBalance.spendableBalance,
            locale,
          );
          balance = mojoToTwo(walletBalance.spendableBalance);
          break;
        case WalletType.CAT:
...
/* ========================================================================== */
/*                              NFT Offer Editor                              */
/*           Currently only supports a single NFT <--> XTWO/CAT offer          */
/* ========================================================================== */
