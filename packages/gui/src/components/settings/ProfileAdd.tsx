...
export default function ProfileAdd() {
  ...
  function handleClick() {
    openExternal('https://faucet.twochain.top/');
  }
  ...
  const standardBalance = mojoToTwoLocaleString(balance?.confirmedWalletBalance);
      ...
      <Form methods={methods} onSubmit={handleSubmit}>
        ...
        <StyledCard>
          <Flex flexDirection="column" gap={2.5} paddingBottom={1}>
            <Trans><strong>Need some XTWO?</strong></Trans>
          </Flex>
          <div style={{cursor: "pointer"}}>
            <Flex paddingBottom={5}>
              <Typography onClick={handleClick} sx={{ textDecoration: "underline" }}>Get Mojos from the Two Faucet</Typography>
            </Flex>
          </div>
          <Flex flexDirection="column" gap={2.5} paddingBottom={1}>
          ...
          <Flex flexDirection="column" gap={2.5} paddingBottom={3}>
            <Typography variant="caption">
              <Trans>Balance: {standardBalance} XTWO</Trans>
            </Typography>
          </Flex>
          <Flex flexDirection="column" gap={2.5} paddingBottom={1}>
            <Fee
          ...
          <Flex flexDirection="column" gap={2.5} paddingBottom={3}>
            <Typography variant="caption">
              <Trans>Recommended: 0.000005 XTWO</Trans>
            </Typography>
          </Flex>
