...
import { Tokens } from '@two/icons';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@two/core';
import { WalletType } from '@two/api';
import type { Wallet } from '@two/api';
import { useGetWalletsQuery } from '@two/api-react';
...
export default function OfferBuilderTokensSection(
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={
        <Trans>Two Asset Tokens (CATs) are tokens built on top of XTWO</Trans>
      }
