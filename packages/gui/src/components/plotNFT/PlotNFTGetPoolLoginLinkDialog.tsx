...
import { Button, CopyToClipboard, Flex, Link, Loading } from '@two/core';
import {
  Alert,
  Dialog,
  DialogActions,
...
import { useGetPoolLoginLinkQuery } from '@two/api-react';
import type { PlotNFT, PlotNFTExternal } from '@two/api';
          ...
          {isLoading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/xone-network/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >
