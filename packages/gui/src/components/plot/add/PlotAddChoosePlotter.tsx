...
import { CardStep, Select, StateColor } from '@two/core';
import { useGetPlottersQuery } from '@two/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@two/api';
import type { Plotter, PlotterMap } from '@two/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => a == PlotterName.TWOPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Two Proof of Space plotter. If unsure,
            use the default Two Proof of Space plotter.
        </Trans>
      </Typography>
