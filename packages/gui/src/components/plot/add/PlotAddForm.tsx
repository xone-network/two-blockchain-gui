...
import { defaultPlotter, toBech32m, fromBech32m } from '@two/api';
import {
  useStartPlottingMutation,
  useCreateNewPoolWalletMutation,
} from '@two/api-react';
import { useForm, SubmitHandler } from 'react-hook-form';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@two/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.TWOPOS),
  });
