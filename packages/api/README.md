...
![Alt text](https://www.twochain.top/img/two_logo.svg)

This library provides support for TypeScript/JavaScript [Two](https://www.twochain.top) apps to access the [Two Blockchain RPC](https://github.com/xone-network/two-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:

- Making requests to the Two Blockchain RPC.
...
```ts
import Client, { Wallet } from '@two/api';
