          ...
          <Flex flexDirection="column" gap={3}>
            <Flex flexDirection="column" gap={1}>
              <Flex alignItems="center" gap={1}>
                ...
                <Tooltip title="The amount of Two you enter must correspond to an even amount of mojos. One additional mojo will be added to the total amount for security purposes.">
