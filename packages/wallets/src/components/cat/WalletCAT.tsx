...
import { Flex, Loading, MenuItem, useOpenDialog } from '@two/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@two/api-react';
import { Offers as OffersIcon } from '@two/icons';
