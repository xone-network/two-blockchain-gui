...
This library provides react hooks on the top of @two/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under do hood.
...
- Automatically refresh queries when data changed (using events from Two Blockchain).
...
import { useGetPublicKeysQuery } from '@two/api-react';
...
import { store, api } from '@two/api-react';
